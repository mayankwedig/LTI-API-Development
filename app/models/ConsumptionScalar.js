...
var ConsumptionScalarsSchema = new mongoose.Schema({
...
mongoose.model('ConsumptionScalar', ConsumptionScalarsSchema);

module.exports = mongoose.model('ConsumptionScalar');